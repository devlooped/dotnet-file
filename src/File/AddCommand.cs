...
class AddCommand(Config configuration) : Command(configuration)
{
        ...
        foreach (var file in Files)
        {
            ...
            try
            {
                ...
                if (!DryRun)
                {
                    ...
                    var path = file.Path.Contains(Path.AltDirectorySeparatorChar)
    ...
    /// </summary>
    protected virtual AddCommand Clone() => new(Config.Build());
}
